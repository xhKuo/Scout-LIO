...
int main(int argc, char** argv)
{
   ...
   private_nh.param("file_directory", file_directory, std::string("file_directory_to_pcd"));
   ...
   private_nh.param("thre_z_min", thre_z_min, -1.0);
   ...
   private_nh.param("map_resolution", map_resolution, 0.1);
